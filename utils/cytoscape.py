...
PROMPT_TO_VIS_CATEGORY = {
    ...
    'CLINICAL / EPIDEMIOLOGICAL / POPULATION': 'OTHER',
    'ASSOCIATION / INTERACTION / BINDING': 'OTHER',
    'MODIFICATION / CHANGES / ALTERS': 'OTHER',
    'EXPRESSION / DETECTION / IDENTIFICATION': 'OTHER',
    'LIMITATION / INNOVATION / IMPROVEMENT / ADVANCEMENT': 'OTHER',
    'LOCALIZATION / CONTAINMENT / COMPOSITION': 'OTHER',
    'TEMPORAL / SEQUENTIAL RELATIONSHIP': 'OTHER',
    'COMPARISON / EVALUATION / BENCHMARKING': 'OTHER',
    'HYPOTHESIS / ASSUMPTION / PROPOSAL': 'OTHER',
    'REQUIREMENT / ACTIVITY / FUNCTION / PARTICIPATION': 'OTHER',
}
