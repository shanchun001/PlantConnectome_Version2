...
# Map long DB category strings to full display labels (title-cased, not shortened)
_CAT_SHORT = {
    ...
    'TREATMENT / EXPOSURE / PERTURBATION':                                       'Treatment / Exposure / Perturbation',
    # Short forms already in data
    'GENE/PROTEIN': 'Gene / Protein', 'PHENOTYPE': 'Phenotype / Trait / Disease',
    'CELL/ORGAN/ORGANISM': 'Complex / Structure / Compartment / Cell / Organ / Organism',
    'CHEMICAL': 'Chemical / Metabolite / Cofactor / Ligand',
    'TREATMENT': 'Treatment / Perturbation / Stress / Mutant',
    'BIOLOGICAL PROCESS': 'Biological Process / Pathway / Function',
    'GENOMIC/TRANSCRIPTOMIC FEATURE': 'Genomic / Transcriptomic / Proteomic / Epigenomic Feature',
    'METHOD': 'Method / Assay / Experimental Setup / Parameter / Sample',
