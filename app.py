...
def index():
    ...
    preview = {"nodes": [
        ...
        {"data": {"id": "A. THALIANA [ORGANISM]", "type": "organism", "category": "CELL/ORGAN/ORGANISM", "originalId": "A. thaliana"}},
        {"data": {"id": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "type": "gene identifier", "category": "GENE IDENTIFIER", "originalId": "(PSAD-1, PSAD1, AT4G02770)-1"}},
        ...
        {"data": {"id": "OXIDATION OF PHOTOSYSTEM I (PSI) [PHENOTYPE]", "type": "phenotype", "category": "PHENOTYPE", "originalId": "Oxidation of photosystem I (PSI)"}},
        {"data": {"id": "LIGHT-GREEN LEAF COLORATION [PHENOTYPE]", "type": "phenotype", "category": "PHENOTYPE", "originalId": "light-green leaf coloration"}},
        ...
        {"data": {"id": "PHOSPHORYLATION OF THYLAKOID PROTEIN(S) [TREATMENT]", "type": "treatment", "category": "TREATMENT", "originalId": "phosphorylation of thylakoid protein(s)"}},
        {"data": {"id": "INCREASED SENSITIVITY TO LIGHT STRESS [PHENOTYPE]", "type": "phenotype", "category": "PHENOTYPE", "originalId": "increased sensitivity to light stress"}},
        ...
        {"data": {"id": "GROWTH RATE [PHENOTYPE]", "type": "phenotype", "category": "PHENOTYPE", "originalId": "Growth rate"}},
        {"data": {"id": "PSAD MRNA AND PROTEIN(S) [GENE]", "type": "gene", "category": "GENE/PROTEIN", "originalId": "PsaD mRNA and protein(s)"}},
        {"data": {"id": "PQ POOL [METABOLITE]", "type": "metabolite", "category": "CHEMICAL", "originalId": "PQ pool"}},
        {"data": {"id": "REDUCTION BY ABOUT 60% OF THE SUBUNITS OF THE STROMAL RIDGE OF PSI [PHENOTYPE]", "type": "phenotype", "category": "PHENOTYPE", "originalId": "reduction by about 60% of the subunits of the stromal ridge of PSI"}},
        {"data": {"id": "PHOTOSYNTHETIC ELECTRON TRANSPORT [PHENOTYPE, PROCESS]", "type": "phenotype, process", "category": "NA", "originalId": "Photosynthetic electron transport"}},
    ], "edges": [
        {"data": {"id": "edge0", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "REDUCTION BY ABOUT 60% OF THE SUBUNITS OF THE STROMAL RIDGE OF PSI [PHENOTYPE]", "interaction": "show"}},
        {"data": {"id": "edge1", "source": "A. THALIANA [ORGANISM]", "target": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "interaction": "mutant"}},
        {"data": {"id": "edge2", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "PSAD MRNA AND PROTEIN(S) [GENE]", "interaction": "affect levels of"}},
        {"data": {"id": "edge3", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "MRNA EXPRESSION OF MOST GENE(S) INVOLVED IN THE LIGHT PHASE OF PHOTOSYNTHESIS [GENE]", "interaction": "down-regulates"}},
        {"data": {"id": "edge4", "source": "OXIDATION OF PHOTOSYSTEM I (PSI) [PHENOTYPE]", "target": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "interaction": "impaired in"}},
        {"data": {"id": "edge5", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "INCREASED SENSITIVITY TO LIGHT STRESS [PHENOTYPE]", "interaction": "show"}},
        {"data": {"id": "edge6", "source": "PQ POOL [METABOLITE]", "target": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "interaction": "is over-reduced in"}},
        {"data": {"id": "edge7", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "PHOSPHORYLATION OF THYLAKOID PROTEIN(S) [TREATMENT]", "interaction": "analyzed for"}},
        {"data": {"id": "edge8", "source": "PLHCA4 [PROTEIN]", "target": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "interaction": "accumulates in"}},
        {"data": {"id": "edge9", "source": "130 MOST STRONGLY ATTENUATED GENE(S) [GENE]", "target": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "interaction": "downregulated in"}},
        {"data": {"id": "edge10", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "GROWTH RATE [PHENOTYPE]", "interaction": "decreases"}},
        {"data": {"id": "edge11", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "PHOTOSYNTHETIC ELECTRON TRANSPORT [PHENOTYPE, PROCESS]", "interaction": "affect"}},
        {"data": {"id": "edge12", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "PSI AND PSII POLYPEPTIDES [PROTEIN COMPLEX]", "interaction": "diminished"}},
        {"data": {"id": "edge13", "source": "(PSAD-1, PSAD1, AT4G02770)-1 [GENE IDENTIFIER]", "target": "LIGHT-GREEN LEAF COLORATION [PHENOTYPE]", "interaction": "show"}},
    ]}
