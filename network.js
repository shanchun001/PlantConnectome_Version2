  ...
  (function mergeQueryNodes() {
    ...
    // Deduplicate edges (same source → target → interaction → pmid)
    const seen = new Set();
    EDGES_TO_RENDER = EDGES_TO_RENDER.filter(e => {
      const key = `${e.data.source}|${e.data.target}|${e.data.interaction}|${e.data.pmid}`;
  ...
  function generateStyles() {
    const nodeStyles = {
      shapes: {
        ...
        'MICROORGANISM': 'octagon',
        'DISEASE/CONDITION': 'vee',
        'CELL/COMPARTMENT': 'tag',
        'HOST/ORGANISM': 'heptagon',
        'ENVIRONMENT': 'concave-hexagon',
        'TAXONOMY': 'cut-rectangle',
        'OTHER': 'star',
      },
      colors: {
        'GENE/PROTEIN': '#89CFF0',
        ...
        'TREATMENT': '#E0FFFF',
        'METHOD': '#D2B48C',
        'BIOLOGICAL PROCESS': '#98FB98',
        'MICROORGANISM': '#FFB6C1',
        'DISEASE/CONDITION': '#FF6B6B',
        'CELL/COMPARTMENT': '#AFEEEE',
        'HOST/ORGANISM': '#F0E68C',
        'ENVIRONMENT': '#87CEEB',
        'TAXONOMY': '#FFC0CB',
        'OTHER': '#FFA07A',
      },
    ...
    const edgeStyles = {
      colors: {
        ...
        'TREATMENT/EXPOSURE/PERTURBATION/ADMINISTRATION': '#20B2AA',
      ...
      arrows: {
        ...
        'TREATMENT/EXPOSURE/PERTURBATION/ADMINISTRATION': 'triangle',
